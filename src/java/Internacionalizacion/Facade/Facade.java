...
public class Facade {
    ...
    public String habilitarDocente(String responsable, int a) {
        ControladorDocente   d = new ControladorDocente();
        return d.habilitarDocente(responsable,a);
    }
    public String nameRandom(){
        String a= "abcdfghijklmnopqrstuvwxyz123456789";
        String rta= "";
               
        for (int i = 0; i < 10; i++) {
            rta+=a.charAt((int)(Math.random()*34));
        }
        return rta;
    }
    ...
    public String registrarConvenio(String radicado, String nombre, String descripcion, String fecharadicacion, String fechainicio, String fechaterminacion, String vigencia, String estado, String tipo, int entidad, String urlimagen) throws Exception {
        ControladorConvenio s = new ControladorConvenio();
        System.out.println(urlimagen);
        return s.registrarConvenio(radicado, nombre, descripcion, fecharadicacion, fechainicio, fechaterminacion, vigencia, estado, tipo, entidad, urlimagen);
    }
