            ...
            <table class="ufps-table" cellspacing="0" width="100%">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><center><a href="modificarModulo.jsp?nombre=<%=dto.getNombre()%>&descripcion=<%=dto.getDescripcion()%>&url=<%=dto.getUrl()%>">Modificar</a></center> </td>
                        <td><center><a href="procesar/eliminarModulo.jsp?nombre=<%=dto.getNombre()%>&descripcion=<%=dto.getDescripcion()%>&url=<%=dto.getUrl()%>">Eliminar</a></center> </td>
                </tr>
                <% }%>
                </tbody>
            </table>
