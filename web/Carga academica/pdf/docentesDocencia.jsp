...
<a href=></a>
<%
    FileOutputStream archivo = new FileOutputStream("C:/xampp/htdocs/SiteEstadistico/web/Carga academica/informes/docentesDocencia.pdf");
    ...
    PdfPCell titulo = new PdfPCell(new Paragraph("Carga Académica Docentes-Docentes Docencia", FontFactory.getFont("arial", 14, Font.BOLD)));
    titulo.setColspan(4);
    ...
    String profes[]=c.consultarDocentesDocencia().split(",");
    ...
    documento.add(tabla);
    documento.close();
request.getSession().setAttribute("pdf","Exito generó el pdf Docentes de Docencia");
