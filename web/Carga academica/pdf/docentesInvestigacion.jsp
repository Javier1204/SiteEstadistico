...
<%
    ...
    FileOutputStream archivo = new FileOutputStream(rutaPrueba + "/docentesInvestigacion.pdf");
    ...
    PdfPCell titulo = new PdfPCell(new Paragraph("Carga Académica Docentes-Docentes Investigación", FontFactory.getFont("arial", 14, Font.BOLD)));
    titulo.setColspan(4);
    ...
    String profes[]=c.consultarDocentesInvestigacion().split(",");
    ...
    documento.add(tabla);
    documento.close();
request.getSession().setAttribute("pdf","Exito generó el pdf Docentes de Investigación");
