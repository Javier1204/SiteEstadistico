...
<a href=></a>
<%
    FileOutputStream archivo = new FileOutputStream("C:/xampp/htdocs/SiteEstadistico/web/Carga academica/informes/docentesAdministrativos.pdf");
    ...
    PdfPCell titulo = new PdfPCell(new Paragraph("Carga Académica Docentes-Docentes Administrativos", FontFactory.getFont("arial", 14, Font.BOLD)));
    titulo.setColspan(4);
    ...
    String profes[]=c.consultarDocentesAdministrativos().split(",");
    ...
    documento.add(tabla);
    documento.close();
request.getSession().setAttribute("pdf","Exito generó el pdf Docentes Administrativos");
