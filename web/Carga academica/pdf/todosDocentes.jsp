...
<a href=></a>
<%
    FileOutputStream archivo = new FileOutputStream("C:/xampp/htdocs/SiteEstadistico/web/Carga academica/informes/todosDocentes.pdf");
    ...
    PdfPCell titulo = new PdfPCell(new Paragraph("Carga Académica Docentes-Todos Los Docentes", FontFactory.getFont("arial", 14, Font.BOLD)));
    titulo.setColspan(4);
    ...
    documento.add(tabla);
    documento.close();
request.getSession().setAttribute("pdf","Exito generó el pdf de todos los Docentes");
