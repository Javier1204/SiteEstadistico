                        ...
                        <tr>
                            ...
                            <td  data-field="modificar">
                                <%if (dto.isModificable()) {
                                    %><button type="submit" href="informacionProyecto.jsp?id=<%=dto.getProyecto_id()%>
                                            &nombre=<%=dto.getProyecto_name()%>&keywords=<%=dto.getKeywords()%>
                                            &semillero=<%=dto.getSemillero()%>&descripcion=<%=dto.getDesc()%>" class="ufps-btn">Modificar</button>
                                <%
                                } else {%>
                            ...
                            <td  data-field="subir_entregable">
                                <button type="submit" href="subirEntregables.jsp?proyecto=<%=dto.getProyecto_id()%>"class="ufps-btn">Subir entregable</button>
                            </td>
                        </tr>
                        <%}
                        %>
