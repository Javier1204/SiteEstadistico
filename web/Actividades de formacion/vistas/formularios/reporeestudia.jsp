...
<form class="form-horizontal" method="POST" name="formactividad"  name="registroActividad" id="registrarActividad">
                <div class="form-group">
                     <label for="inputNombre" class="col-sm-2 control-label">Estudiante</label>
                   <div class="col-sm-10">
                       <%=modact.ListarEstudiantes()%>
                </div>
                   </div>
                 ...
                 <center>
                      <button  type="button"  data-loading-text="Loading..." id="botoareestu" class="btn-danger btn-lg" onclick="ReporteEstudi();" >Buscar</button>
                ...
                <div class="col-sm-12">
                    <div class="form-group">
                        <div class="fg-line" id="resultdarepoestudi">
