<%-- 
    Document   : newjsp
    Created on : 27/11/2016, 09:42:01 PM
    Author     : Usuario
--%>
...
Facade f = new Facade();
practicaDTO p= new practicaDTO(idpractica,ano_practica, semestre_practica, id_convenio, estado, id_docente, id_estudiante, id_perfil, id_tutor);
...
String r = f.editarPractica(p);//corralo
System.out.println("aqui llego"+p.toString());
request.getSession().setAttribute("respuesta_editar_practica", r);
%>

    
<%
response.sendRedirect("editar_practica.jsp?idpractica=" +idpractica );
