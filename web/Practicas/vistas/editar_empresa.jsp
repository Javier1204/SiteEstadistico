        ...
        <header>
            ...
            <div class="ufps-navbar ufps-container " id="menu"  center>
             <div class="ufps-container-fluid">
                ...
                <div class="ufps-navbar-left nav"><li><a href="registro_practicas" class="  ufps-navbar-btn  " >Practicas </a></li></div>
     ...
     <BR>     
       ...
       <center><div class="ufps-col-tablet-12 ">  
            <div class="btn-group btn-group-justified"">
                <button type="submit" class="ufps-btn">Editar Empresa</button>
