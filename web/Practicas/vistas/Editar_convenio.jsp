        ...
        <header>
            ...
            <div class="ufps-navbar ufps-container " id="menu"  center>
             <div class="ufps-container-fluid">
                ...
                <div class="ufps-navbar-left nav"><li><a href="index.jsp" class="  ufps-navbar-btn  " >Home </a></li></div>
                 
                <div class="ufps-navbar-left nav"><li><a href="estudiantes.jsp" class="  ufps-navbar-btn  " >Estudiantes </a></li></div>
                 
                <div class="ufps-navbar-left nav"><li><a href="mostrar_empresa.jsp" class="  ufps-navbar-btn  " >Empresa </a></li></div>
          ...
          <fieldset>
              ...
              <div class="ufps-col-tablet-5 ufps-col-tablet-offset-1">
                                 <div class="form-group">
                                     ...
                                     <input name="estado" type="text" class="ufps-input-line" id="linea5" >
                                 </div>  
              </div>
