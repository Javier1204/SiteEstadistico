    ...
    <div class="wrapper wrapper-content animated fadeInRight">
        <div class="ibox-content p-xl">
            ...
            <div class="col-sm-8">
                <form role="form" class="form-horizontal" enctype="multipart/form-data"   method="post"  id="FromDataPersonal"> 
                    ...
                    <div class="form-group"><label class="col-sm-3 control-label">Nombre</label>
                        ...
                        <div class="col-sm-9"><input type="text" class="form-control" name="nombre" id="nombre" placeholder="Nombre" value="<%=capi[0]%>" required></div>
                    </div>
                     <div class="hr-line-dashed"></div>
                    <div class="form-group"><label class="col-sm-3 control-label">Apellidos</label>

                        <div class="col-sm-9"><input type="text" class="form-control" name="apellido" id="apellido" placeholder="Apellido" value="<%=capi[1]%>" required></div>
                    </div>
                     <div class="hr-line-dashed"></div>
                     ...
                     <div class="form-group"><label class="col-sm-3 control-label">Numero Documento</label>
                         ...
                         <div class="col-sm-9"><input type="number" class="form-control" name="documento" id="documento" value="<%=capi[3]%>" placeholder="Numero Documento" required></div>
                    </div>
                   <div class="hr-line-dashed"></div> 
                     ...
                     <div class="form-group"><label class="col-sm-3 control-label">Fecha Nacimiento</label>
                         ...
                         <div class="col-sm-9">
                            <div class="input-group date">
                                <span class="input-group-addon"><i class="fa fa-calendar"></i></span><input type="text" id="fecha_nacimiento" value="<%=capi[4]%>"  name="fecha_nacimiento" class="form-control date-picker" >
                                </div>
                         </div>
                    </div>
                   <div class="hr-line-dashed"></div> 
                    ...
                    <div class="form-group">
                        <div class="col-sm-4 col-sm-offset-6">
                                             <button  type="button"  data-loading-text="Loading..." id="butactualizareditar" class="btn btn-primary" onclick="EditarDataPersonal();" >Actualizar</button>
           ...
           <div class="row">
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        <div class="fg-line" id="resultDataPersonaleditar">
...
$('#tipo_documento').val(<%=capi[2]%>);
$('#pais').val(<%=capi[5]%>);


$('#genero').val(<%=capi[8]%>);
$('#edad').val(<%=capi[9]%>);
$('#estado_civil').val(<%=capi[10]%>);
$('#fecha_nacimiento').datepicker({
         ...
         $("#departamento").change(function () {
            var selec = $("#departamento option:selected").val();
            if (selec == 0) {
  ...
  '<option value="27">VITERBO</option> '
        ...
        $('#departamento').val(<%=capi[6]%>);
 $("#departamento").change();
        
        $('#municipio').val(<%=capi[7]%>);
