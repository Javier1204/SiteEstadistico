    ...
    <div class="wrapper wrapper-content animated fadeInRight">
        <div class="ibox-content p-xl">
            ...
            <div class="col-sm-8">
                <form role="form" class="form-horizontal" enctype="multipart/form-data"   method="post"  id="FromEditDataAcademica"> 
                    ...
                    <div class="form-group"><label class="col-sm-7 control-label">Colegio donde se graduo de bachiller</label>
                        ...
                        <div class="col-sm-5"><input type="text" class="form-control" name="colegio_grado" id="colegio_grado" placeholder="" value="<%=capi[1]%>" required></div>
                    </div>
                       <div class="hr-line-dashed"></div>
                    <div class="form-group"><label class="col-sm-7 control-label">Especialidad del colegio donde se graduo</label>

                        <div class="col-sm-5"><input type="text" class="form-control" name="especialidad" id="especialidad" value="<%=capi[2]%>" placeholder="especialidad" required></div>
                    </div>
                       <div class="hr-line-dashed"></div>
                    ...
                    <div class="form-group">
                        ...
                        <label class="col-sm-3 control-label">Lectura</label>
                         ...
                         <div class="col-sm-3"><input type="number" class="form-control" name="lectura" id="lectura" placeholder="" value="<%=capi[9]%>" required></div>
                         <div class="col-sm-2"></div>
                    </div>
                   <div class="hr-line-dashed"></div> 
                    ...
                    <div class="form-group">
                        ...
                        <label class="col-sm-3 control-label">Ciencias Naturales</label>
                         ...
                         <div class="col-sm-3"><input type="number" class="form-control" name="naturales" id="naturales" placeholder="" value="<%=capi[10]%>" required></div>
                         <div class="col-sm-2"></div>
                    </div>
                   <div class="hr-line-dashed"></div> 
                    ...
                    <div class="form-group">
                        ...
                        <label class="col-sm-3 control-label">Ciencias Sociales</label>
                         ...
                         <div class="col-sm-3"><input type="number" class="form-control" name="sociales" id="sociales" placeholder="" value="<%=capi[11]%>" required></div>
                         <div class="col-sm-2"></div>
                    </div>
                   <div class="hr-line-dashed"></div> 
                    ...
                    <div class="form-group">
                        ...
                        <label class="col-sm-3 control-label">Ingles</label>
                         ...
                         <div class="col-sm-3"><input type="number" class="form-control" name="ingles" id="ingles" placeholder="" value="<%=capi[12]%>" required></div>
                         <div class="col-sm-2"></div>
                    </div>
                   <div class="hr-line-dashed"></div> 
                    ...
                    <div class="form-group">
                        <div class="col-sm-4 col-sm-offset-6">
                           <button  type="button"  data-loading-text="Loading..." id="botoacademieditar" class="btn btn-primary" onclick="EditarDataAcademica();" >Actualizar</button>
           ...
           <div class="row">
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        <div class="fg-line" id="resultdataacedemicaedit">
...
<script src="../EstudiantesdeprimerSemestre/js/plugins/iCheck/icheck.min.js"></script>
  ...
  '<option value="27">VITERBO</option> '
            ...
            $('#departamento_grado').val(<%=capi[6]%>);
 $("#departamento_grado").change();
$('#municipio_grado').val(<%=capi[7]%>);
