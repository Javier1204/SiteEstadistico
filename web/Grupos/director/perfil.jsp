...
<html lang="es">
    ...
    <%
        request.setAttribute("director", fachada.getUsuario());
    %>
    <body>
        <!--Contenido-->
            ...
            <section>
                <div class="ufps-row ufps-table">
                    ...
                    <div class="ufps-black ufps-col-mobile-12 ufps-col-tablet-10">
                        ...
                        <h1 class="ufps-red">${sessionScope.grupo.nombregrupo}</h1>
                        <h2 class="ufps-red">Bienvenido</h2>
                        <div class="ufps-col-mobile-12 ufps-col-tablet-6">
                            <div class="ufps-col-mobile-12 ufps-col-tablet-6">
                                <h3 class="ufps-red">Nombre</h3>
                            </div>
                            <div class="ufps-col-mobile-12 ufps-col-tablet-6">
                                <h4>${director.persona.nombres} ${director.persona.apellidos}</h4>
                            </div>
                            <div class="ufps-col-mobile-12 ufps-col-tablet-6">
                                <h3 class="ufps-red">Código</h3>
                            </div>
                            <div class="ufps-col-mobile-12 ufps-col-tablet-6">
                                <h4>${director.persona.codigo}</h4>
                            </div>
                            <div class="ufps-col-mobile-12 ufps-col-tablet-6">
                            </div>
                    ...
                    <div class="ufps-col-mobile-12">
                        <div class="ufps-col-mobile-12 ufps-col-tablet-6 ufps-text-center">
                            <a href="bitacora.jsp" class="ufps-btn">Ver Bitácora</a>
                        </div>
                        <div class="ufps-col-mobile-12 ufps-col-tablet-6 ufps-text-center">
                            <a href="editarDatos.jsp" class="ufps-btn">Editar</a>
                        </div>
                    </div>
